...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/select2.css') ?>" media="all" />
        ...
        <script type="text/javascript" src="<?= base_url('assets/js/jquery.mtz.monthpicker.js') ?>"></script>
