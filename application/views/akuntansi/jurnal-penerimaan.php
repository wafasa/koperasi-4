<script type="text/javascript">
    $(function() {
        ...
        $('#bt_cari').click(function() {
            ...
            $('#datamodal_no .title h4').html('Tambah Jurnal Penerimaan');
    ...
    function tampilkan(p, id_bukubesar) {
        ...
        $.ajax({
            ...
            data: $('#form_jurnal').serialize()+'&jenis=Penerimaan',
            dataType: 'json',
    ...
    function edit_jurnal(no_transaksi) {
        $('#datamodal_no').modal('show');
        $('#datamodal_no .title h4').html('Edit Jurnal penerimaan');
        $.ajax({
            type: 'GET',
    ...
    function save_jurnal() {
        ...
        $.ajax({
            type : 'POST',
            url: '<?= base_url("api/akuntansi/jurnal") ?>',
            data: $('#form').serialize()+'&jenis=Penerimaan',
            cache: false,
            dataType : 'json',
            success: function(data) {
