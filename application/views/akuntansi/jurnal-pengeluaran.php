<script type="text/javascript">
    $(function() {
        ...
        $('#bt_tambah').click(function() {
            ...
            $('#datamodal_no .title h4').html('Tambah Jurnal Pengeluaran');
        ...
        $('.custom-user, .form-control, .select2-input').change(function() {
            if ($(this).val() !== '') {
    ...
    function tampilkan(p, id_bukubesar) {
        ...
        $.ajax({
            ...
            data: $('#form_jurnal').serialize()+'&jenis=Pengeluaran',
            dataType: 'json',
    ...
    function edit_jurnal(no_transaksi) {
        $('#datamodal_no').modal('show');
        $('#datamodal_no .title h4').html('Edit Jurnal Pengeluaran');
        $.ajax({
            type: 'GET',
    ...
    function tambah_rek_debet() {
        var jml = $('.rows_debet').length;
        var str = '<div class="rows_debet" style="margin-bottom: 10px; display:block;">'+
                ...
                '</div>'+
                '</div>'+
                '<div class="col-lg-1"><button type="button" class="btn btn-xs" onclick="removeRekDebet(this);"><i class="fa fa-trash-o"></i></button></div>'+
                '</div>';
    ...
    function save_jurnal(){
        ...
        $.ajax({
            type : 'POST',
            url: '<?= base_url("api/akuntansi/jurnal") ?>',
            data: $('#form').serialize()+'&jenis=Pengeluaran',
            cache: false,
            dataType : 'json',
            success: function(data) {
          ...
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Daftar List <?= $title ?></h4>
                <div class="tools">
                    <button class="btn btn-mini btn-primary" id="bt_tambah"><i class="fa fa-plus-circle"></i> Tambah Data</button>
...
<div id="datamodal_no" class="modal fade">
    <div class="modal-dialog" style="width: 880px; height: 100%;">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <div class="widget-header">
                <div class="title">
                    <h4>Tambah Jurnal Pengeluaran</h4>
                </div>
            </div>
        </div>
                        ...
                        <table width="100%" class="table" id="form_jurnal" cellspacing="0">
                            <tbody>
                                <tr valign="top">
                                    ...
                                    <td width="1%">:</td>
                                    <td width="74%">
                                        <div class="col-lg-5"><input type="text" name="tanggal" id="tanggal" autocomplete="off" class="custom-user" /></div>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    ...
                                    <td width="1%">:</td>
                                    <td width="74%">
                                        <div class="col-lg-12"><input type="text" name="kode_transaksi" id="kode_transaksi" class="custom-user" /></div>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <td width="25%"></td>
                                    ...
                                    <td width="74%">
                                        <div class="col-lg-12">
                                            <button type="button" class="btn btn-default btn-xs" onclick="tambah_rek_debet();"><i class="fa fa-plus-circle"></i> Rek. Debet</button>
                                            <button type="button" class="btn btn-default btn-xs" onclick="tambah_rek_kredit();"><i class="fa fa-plus-circle"></i> Rek. Kredit</button>
                                        </div>
                                    </td>
                                </tr>
                                <tr valign="top">
                ...
                <div class="col-md-12">
                    <div class="widget-body">
                        <div class="form-group">
                            <label for="barang" class="col-lg-3 control-label">Tanggal Transaksi:</label>
                            <div class="col-lg-8">
