...
";
	...
	$sql = mysql_query("select n.*, t.saldo, th.* from tb_nasabah_tabungan n, tb_tabungan t, tb_tab_history th where n.no_agt_tab = t.no_agt_tab and t.no_tabungan = th.no_tabungan and n.no_agt_tab = '$_GET[id]'");
