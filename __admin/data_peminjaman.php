...
";
	...
	$jml = mysql_fetch_array(mysql_query("select sum(jml_pinjaman) as total, sum(sisa_angsuran) as sia from tb_pinjaman p, tb_nasabah n where n.no_anggota = p.no_anggota and n.rek_pinjaman = '$_POST[val]' and status_lunas = '0'",$conn));
	}
